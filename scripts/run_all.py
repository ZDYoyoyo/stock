...
def main():
    ...
    _flownote = (
        ...
        "\n📏 量能倍數＝今日量÷近20日均量(>1.5爆量·<1量縮)；券資比%＝融券÷融資餘額(空方相對力道)"
    ...
    with open(path, "w", encoding="utf-8") as f:
        ...
        _section(f, "🟡 波段｜T11 法人吸貨（上市投信/上櫃外資）", df11,
                 ["stock_id", "name", "market", "產業", "investor", "close", "今日收盤", "今日漲跌%",
                  "外資今日", "投信今日", "自營今日", "融資今日", "融券今日", "外資", "投信", "自營", "融資增減", "融券增減", "外資連", "投信連", "自營連", "主導度%", "量能倍數", "券資比%", "融資佔量%", "融券佔量%", "籌碼訊號",
        ...
        _section(f, "🚀 成長｜T12 月營收動能（YoY強+近月加速）", df12,
                 ["stock_id", "name", "market", "產業", "今日收盤", "今日漲跌%",
                  "外資今日", "投信今日", "自營今日", "融資今日", "融券今日", "外資", "投信", "自營", "融資增減", "融券增減", "外資連", "投信連", "自營連", "主導度%", "量能倍數", "券資比%", "融資佔量%", "融券佔量%", "籌碼訊號", "YoY%",
                  "累計YoY%", "MoM%", "加速度", "站上20MA", "score"], n=20, note=_flownote.strip())
        _section(f, "🟢 長期｜價值+成長+配息", dflt,
                 ["stock_id", "name", "產業", "今日收盤", "今日漲跌%",
                  "外資今日", "投信今日", "自營今日", "融資今日", "融券今日", "外資", "投信", "自營", "融資增減", "融券增減", "外資連", "投信連", "自營連", "主導度%", "量能倍數", "券資比%", "融資佔量%", "融券佔量%", "籌碼訊號", "殖利率%", "PER",
        ...
        _section(f, "🔴 當沖候選｜高波動+高流動（盤中盯，非即時訊號）", dfdt,
                 ["stock_id", "name", "market", "產業", "今日收盤", "今日漲跌%", "多空傾向", "與大盤",
                  "外資今日", "投信今日", "自營今日", "融資今日", "融券今日", "外資", "投信", "自營", "融資增減", "融券增減", "外資連", "投信連", "自營連", "主導度%", "券資比%", "融資佔量%", "融券佔量%", "籌碼訊號", "當日振幅%", "均振幅%", "量能倍數"],
                 note=notedt)
    ...
    blocks = [
        {"title": "🟡 波段｜T11 法人吸貨（上市投信/上櫃外資）", "df": df11, "note": note11,
         "cols": ["stock_id", "name", "market", "產業", "investor", "close", "今日收盤", "今日漲跌%",
                  "外資今日", "投信今日", "自營今日", "融資今日", "融券今日", "外資", "投信", "自營", "融資增減", "融券增減", "外資連", "投信連", "自營連", "主導度%", "量能倍數", "券資比%", "融資佔量%", "融券佔量%", "籌碼訊號",
                  "price_gain_%", "consec_buy_days", "buy_ratio_%", "千張大戶%", "風險", "紅旗", "score"],
         "signed": ["今日漲跌%", "price_gain_%", "外資今日", "投信今日", "自營今日", "融資今日", "融券今日", "外資", "投信", "自營", "融資增減", "融券增減", "外資連", "投信連", "自營連", "主導度%", "融資佔量%", "融券佔量%", "籌碼訊號"],
        ...
        {"title": "🟡 波段｜T16 抗跌強勢", "df": df16, "note": note16, "n": 15,
         ...
         "signed": ["今日漲跌%", "return_%", "vs_market_%", "外資今日", "投信今日", "自營今日", "融資今日", "融券今日", "外資", "投信", "自營", "融資增減", "融券增減", "外資連", "投信連", "自營連", "主導度%", "融資佔量%", "融券佔量%", "籌碼訊號"],
        ...
        {"title": "🚀 成長｜T12 月營收動能（YoY強+近月加速）", "df": df12, "n": 20, "note": _flownote.strip(),
         ...
         "signed": ["今日漲跌%", "外資今日", "投信今日", "自營今日", "融資今日", "融券今日", "外資", "投信", "自營", "融資增減", "融券增減", "外資連", "投信連", "自營連", "主導度%", "融資佔量%", "融券佔量%", "籌碼訊號",
                    "YoY%", "累計YoY%", "MoM%", "加速度"]},
        {"title": "🟢 長期｜價值+成長+配息", "df": dflt, "skipped": args.skip_longterm, "note": _flownote.strip(),
         "cols": ["stock_id", "name", "產業", "今日收盤", "今日漲跌%",
                  "外資今日", "投信今日", "自營今日", "融資今日", "融券今日", "外資", "投信", "自營", "融資增減", "融券增減", "外資連", "投信連", "自營連", "主導度%", "量能倍數", "券資比%", "融資佔量%", "融券佔量%", "籌碼訊號", "殖利率%", "PER", "ROE估%",
                  "營收YoY%", "連配息年", "score"],
         "signed": ["今日漲跌%", "外資今日", "投信今日", "自營今日", "融資今日", "融券今日", "外資", "投信", "自營", "融資增減", "融券增減", "外資連", "投信連", "自營連", "主導度%", "融資佔量%", "融券佔量%", "籌碼訊號", "營收YoY%"]},
