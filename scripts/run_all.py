...
def main():
    ...
    with open(path, "w", encoding="utf-8") as f:
        ...
        _section(f, "🟡 波段｜T11 法人吸貨（上市投信/上櫃外資）", df11,
                 ["stock_id", "name", "market", "產業", "investor", "close", "今日收盤", "今日漲跌%", "均線排列", "季線年線", "20MA乖離%", "52週位置%", "成交額億",
        ...
        _section(f, "🟡 波段｜T16 抗跌強勢", df16,
                 ["stock_id", "name", "market", "產業", "今日收盤", "今日漲跌%", "均線排列", "季線年線", "20MA乖離%", "52週位置%", "成交額億",
                  "外資今日", "投信今日", "自營今日", "融資今日", "融券今日", "外資", "投信", "自營", "融資增減", "融券增減", "外資連", "投信連", "自營連", "主導度%", "今日量張", "量能倍數", "券資比%", "融資佔量%", "融券佔量%", "籌碼訊號",
        ...
        _section(f, "🟢 長期｜價值+成長+配息", dflt,
                 ["stock_id", "name", "產業", "今日收盤", "今日漲跌%", "均線排列", "季線年線", "20MA乖離%", "52週位置%", "成交額億",
    ...
    blocks = [
        {"title": "🟡 波段｜T11 法人吸貨（上市投信/上櫃外資）", "df": df11, "note": note11,
         "cols": ["stock_id", "name", "market", "產業", "investor", "close", "今日收盤", "今日漲跌%", "均線排列", "季線年線", "20MA乖離%", "52週位置%", "成交額億",
                  "外資今日", "投信今日", "自營今日", "融資今日", "融券今日", "外資", "投信", "自營", "融資增減", "融券增減", "外資連", "投信連", "自營連", "主導度%", "今日量張", "量能倍數", "券資比%", "融資佔量%", "融券佔量%", "籌碼訊號",
                  "price_gain_%", "consec_buy_days", "buy_ratio_%", "千張大戶%", "風險", "紅旗", "score"],
        ...
        {"title": "🟡 波段｜T16 抗跌強勢", "df": df16, "note": note16, "n": 15,
         "cols": ["stock_id", "name", "market", "產業", "今日收盤", "今日漲跌%", "均線排列", "季線年線", "20MA乖離%", "52週位置%", "成交額億",
                  "外資今日", "投信今日", "自營今日", "融資今日", "融券今日", "外資", "投信", "自營", "融資增減", "融券增減", "外資連", "投信連", "自營連", "主導度%", "今日量張", "量能倍數", "券資比%", "融資佔量%", "融券佔量%", "籌碼訊號",
        ...
        {"title": "🟢 長期｜價值+成長+配息", "df": dflt, "skipped": args.skip_longterm, "note": _flownote.strip(),
         "cols": ["stock_id", "name", "產業", "今日收盤", "今日漲跌%", "均線排列", "季線年線", "20MA乖離%", "52週位置%", "成交額億",
